...
typedef struct { 
	...
	const char *instream_x; /**<  [in] The stream should be of size (param_N * 1) bytes. */
	char *outstream_z; /**<  [out] The stream should be of size (param_N * 1) bytes. */
} CpuStream_actions_t;
